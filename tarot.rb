class Tarot
    def tarot_spread
      ...
      # Print the selected cards and their descriptions
      puts "Your Tarot Card Spread:"
      puts "-----------------------"
      selected_cards.each do |card|
        puts "#{card[:name]}: #{card[:description]}"
      end
    end
    ...
    def create_deck
      # Define the tarot deck as an array of hashes
      [
        # Major Arcana
...
# Create a new Tarot instance
tarot = Tarot.new
  
# Call the tarot_spread method on the Tarot instance
tarot.tarot_spread
